...
#ifndef STBLIBAPP_FRAMEBUFFERTEXTURE_H
#define STBLIBAPP_FRAMEBUFFERTEXTURE_H
...
//FrameBuffer纹理附着和深度附着
//素材要求：纹理宽高大于窗口宽高

class FrameBufferTexture {
public:
    FrameBufferTexture(GlobalContexts *global_context);
    ~FrameBufferTexture();
...
#endif //STBLIBAPP_FRAMEBUFFERTEXTURE_H
