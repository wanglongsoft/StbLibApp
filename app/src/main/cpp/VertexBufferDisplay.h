...
#ifndef STBLIBAPP_VERTEXBUFFERDISPLAY_H
#define STBLIBAPP_VERTEXBUFFERDISPLAY_H
...
class VertexBufferDisplay {
public:
    VertexBufferDisplay(GlobalContexts *global_context);
    ~VertexBufferDisplay();
...
#endif //STBLIBAPP_VERTEXBUFFERDISPLAY_H
